                ...
                <Form method="post" noValidate>
                  ...
                  <div className="my-5 rounded border border-[#bce8f1] bg-[#d9edf7] p-4 text-[#31708f]">
                    <p>
                      ...
                      the data into the textfield. Accepted data formats are
                      described{" "}
                      <a
                  ...
                  <div className="mb-4 mt-6">
                    <label
                      htmlFor="fileInput"
                      className=" rounded border border-gray-200 px-4 py-2 text-black hover:bg-[#e6e6e6] disabled:border-[#ccc] disabled:text-[#8a8989] cursor-pointer"
                    >
                      Select a file
                    </label>
                    <Input
