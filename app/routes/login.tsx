	...
	return (
		<div className="flex h-screen flex-col">
			...
			<div className="flex h-full w-full justify-center py-10">
				<div className="flex h-full w-full max-w-3xl items-center justify-center rounded-lg p-6 dark:bg-transparent dark:text-dark-text dark:shadow-none">
					<Form method="post" className="space-y-6" noValidate>
						...
						<button
							type="submit"
							className="hover:bg-blue-600 w-full rounded bg-blue-500 px-4 py-2 text-white focus:bg-blue-400"
						>
							Log in
						</button>
