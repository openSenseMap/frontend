        ...
        <div className="flex">
          {data.map((feature, index) => {
            return (
              <div
                key={index}
                className="flex items-center text-center flex-col justify-center rounded-2xl border-4 border-solid border-green-100 p-4 text-gray-300 dark:border-green-200 dark:text-gray-100 md:m-4 dark:bg-gray-100/[rgba(217,217,217,0.1)]"
              >
