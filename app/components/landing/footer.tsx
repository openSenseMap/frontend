      ...
      <div className="sm:flex sm:items-center sm:justify-between">
        <div className="mt-4 flex w-full items-center space-x-6 sm:mt-0 sm:justify-center">
          ...
          <div className="flex w-1/2 justify-end">
            <a href="https://www.instagram.com/opensenselab/" target="_blank" rel="noreferrer" className="px-8 hover:text-green-100 dark:hover:text-green-200">
              <svg
                className="h-10 w-10"
                fill="currentColor"
                viewBox="0 0 24 24"
            ...
            <a href="https://twitter.com/openSenseLab" target="_blank" rel="noreferrer" className="px-8 hover:text-green-100 dark:hover:text-green-200">
              <svg
                className="h-10 w-10"
                fill="currentColor"
                viewBox="0 0 24 24"
            ...
            <a href="https://github.com/opensenselab" target="_blank" rel="noreferrer" className="px-8 hover:text-green-100 dark:hover:text-green-200">
              <svg
                className="h-10 w-10"
                fill="currentColor"
                viewBox="0 0 24 24"
