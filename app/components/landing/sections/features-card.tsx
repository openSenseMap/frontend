...
export default function FeatureCard(item: Feature) {
	return (
		<div
			key={item.id}
			className="border-light-green flex flex-col items-center justify-center rounded-xl border-4 border-solid bg-white p-4 text-center text-4xl text-gray-300 shadow-[5px_5px_rgba(0,98,90,0.4),8px_8px_rgba(0,98,90,0.3),11px_11px_rgba(0,98,90,0.2),14px_14px_rgba(0,98,90,0.1),17px_17px_rgba(0,98,90,0.05)] dark:bg-gray-900 dark:text-gray-100"
		>
			<div className="text-light-green pb-4 font-serif text-2xl font-extrabold subpixel-antialiased dark:text-green-200">
				{item.title}
			</div>
