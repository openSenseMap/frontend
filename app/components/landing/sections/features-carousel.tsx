			...
			>
				...
				>
					<motion.div
						...
						className="group border-light-green text-light-green relative inline-flex items-center overflow-hidden rounded-full border-2 px-2 py-2 text-lg font-medium hover:bg-gray-50 hover:text-white md:px-3 md:py-3"
					>
						<ArrowLeft className="z-20 h-2 w-2 hover:text-white md:h-6 md:w-6" />
						<span className="ease bg-light-green absolute top-1/2 left-0 block h-0 w-full opacity-100 transition-all duration-400 group-hover:top-0 group-hover:h-full"></span>
