// // import  { type Exposure, type Priority } from "@prisma/client";
...
// export async function participate({ request }: ActionFunctionArgs) {
//   const ownerId = await requireUserId(request);
//   const user = await requireUser(request);
//   const formData = await request.formData();
//   const campaignId = formData.get("campaignId");
//   if (typeof campaignId !== "string" || campaignId.length === 0) {
//     return new Response(JSON.stringify({ errors: { campaignId: "campaignId is required" } }), { status: 400 });
//   }
...
// export async function messageAllUsers({ request }: ActionFunctionArgs) {
//   const formData = await request.formData();
...
// export async function updateCampaignAction({ request }: ActionFunctionArgs) {
//   const formData = await request.formData();
//   const campaignId = formData.get("campaignId");
//   if (typeof campaignId !== "string" || campaignId.length === 0) {
//     return json(
...
// export async function deleteCampaignAction({ request }: ActionFunctionArgs) {
//   const formData = await request.formData();
//   const ownerId = await requireUserId(request);
//   const campaignId = formData.get("campaignId");
//   if (typeof campaignId !== "string" || campaignId.length === 0) {
...
// export async function bookmark({ request }: ActionFunctionArgs) {
//   const formData = await request.formData();
